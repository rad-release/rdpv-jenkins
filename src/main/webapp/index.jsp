...
.login-header {
    background: rgba(0, 0, 0, 0) url("images/top-bg.jpg") repeat-x scroll 0 0;
    border-width: 0;
    height: 60px;
    text-align: center;
}
...
<body id="login-body">
	...
	<div id="login">
		...
		<div class="control-wrap"> <h4><img width="220px" style="padding-right:32px" class="center" alt="lock" src="images/logo-rad.png"></h4>
		<div style="margin-left:50px" class="console_failed">
